...
public class PropietarioDAO {
    ...
    public int create(PropietarioDTO propietario) {
        ...
        try {
            ...
            if (rowsAffected > 0) {
                System.out.println("Propietario almacenado exitosamente");
            }
    ...
    public int update(String id, PropietarioDTO propietario) {
        String sql = "UPDATE propietario SET nombre = ?, apellido = ?, correo = ?, telefono = ?, tipo_documento = ?::tipo_documento, numero_documento = ?, contrasena = ? WHERE id_propietario = ?";
        int rowsAffected = 0;
        ...
        try {
            ...
            stm.setString(1, propietario.getNombre());
            stm.setString(2, propietario.getApellido());
            stm.setString(3, propietario.getCorreo());
            stm.setString(4, propietario.getTelefono());
            stm.setString(5, propietario.getTipoDocumento().name());
            stm.setString(6, propietario.getNumeroDocumento());
            stm.setString(7, propietario.getContrasena());
            stm.setObject(8, UUID.fromString(id));
...
//            System.out.println("campos a cambiar" + campos);
//            for (int i = 0; i < campos.size(); i++) {
